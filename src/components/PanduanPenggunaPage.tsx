...
import { BookOpen, ChevronDown, ChevronUp, Shield, Users, Key, ClipboardList, History, Globe, AlertCircle, CheckCircle, Activity, Clock, FileText } from 'lucide-react';

interface PanduanPenggunaPageProps {
...
export function PanduanPenggunaPage({ onNavigate }: PanduanPenggunaPageProps) {
  ...
  const scrollToSection = (id: string) => {
    ...
    setTimeout(() => {
      ...
      if (ref.current) {
        const yOffset = -120; // Offset untuk fixed header
      ...
      <div className="text-white py-3 md:py-4" style={{ background: 'linear-gradient(135deg, var(--dark-navy-0), var(--dark-navy-20))' }}>
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <h1 className="mb-1 text-white text-3xl">Panduan Pengguna</h1>
